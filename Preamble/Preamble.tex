...
\renewcommand\thesection{\color{RoyalBlue}\arabic{section}}
...
% ¤¤ Indholdsfortegnelse ¤¤ %
\setsecnumdepth{part}		 			% Dybden af nummerede overkrifter (part/chapter/section/subsection)
...
\makechapterstyle{jenor}{					% Definerer kapiteludseende frem til ...
  ...
  \renewcommand\chaptitlefont{\fontfamily{bch}\fontseries{m}\fontshape{ol}\fontsize{20}{25}\selectfont\raggedright\selectfont\color{chaptercolor}}
...
%    \par\vskip-2.5mm\hrule
    ...
    \raisebox{-15pt}{\chapnumfont \thechapter} & {\hspace{1cm}\parbox[b]{\linewidth}{\chaptitlefont ##1}}
